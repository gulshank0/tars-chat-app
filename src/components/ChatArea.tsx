...
export function ChatArea({ conversationId, currentUser, onBack }: ChatAreaProps) {
  ...
  if (!conversation || !messages) {
    return (
      <div className="flex flex-1 flex-col bg-gray-50 dark:bg-black overflow-hidden min-h-0">
        <div className="flex items-center gap-3 border-b border-gray-200 dark:border-zinc-800 bg-white dark:bg-zinc-950 p-4">
          <button onClick={onBack} className="md:hidden rounded-lg p-2 hover:bg-gray-100 dark:hover:bg-gray-900">
            <ArrowLeft className="h-5 w-5 text-gray-600 dark:text-gray-400" />
          </button>
          <div className="h-10 w-10 animate-pulse rounded-full bg-gray-200 dark:bg-gray-900" />
          <div className="space-y-2">
            <div className="h-4 w-32 animate-pulse rounded bg-gray-200 dark:bg-gray-900" />
            <div className="h-3 w-20 animate-pulse rounded bg-gray-200 dark:bg-gray-900" />
          </div>
        </div>
  ...
  return (
    <div className="relative flex flex-1 flex-col bg-gray-50 dark:bg-black overflow-hidden min-h-0">
      {/* Header */}
      <div className="flex items-center gap-3 border-b border-gray-200 dark:border-zinc-800 bg-white dark:bg-zinc-950 px-4 py-3 shadow-sm">
        <button
          onClick={onBack}
          className="md:hidden rounded-lg p-2 hover:bg-gray-100 dark:hover:bg-gray-900 -ml-1"
        >
          <ArrowLeft className="h-5 w-5 text-gray-600 dark:text-gray-400" />
        </button>
        ...
        {isGroup ? (
          ...
          <div className="relative flex-shrink-0">
            ...
            {otherParticipant?.isOnline && (
              <div className="absolute -bottom-0.5 -right-0.5 h-3 w-3 rounded-full border-2 border-white dark:border-black bg-green-500" />
            )}
          </div>
        )}
        ...
        <div className="flex-1 min-w-0">
          ...
          <p className="text-xs text-gray-500 dark:text-gray-400">{headerSubtext}</p>
        </div>
      </div>
      ...
      >
        {messages.length === 0 ? (
          <div className="flex flex-col items-center justify-center h-full text-center">
            <div className="mb-4 flex h-20 w-20 items-center justify-center rounded-full bg-blue-50 dark:bg-blue-900/20">
              <svg className="h-10 w-10 text-blue-300 dark:text-blue-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        {typingUsers && typingUsers.length > 0 && (
          <div className="flex items-center gap-2 py-1">
            <div className="flex space-x-1 rounded-full bg-gray-200 dark:bg-gray-900 px-3 py-2">
              <div className="h-2 w-2 animate-bounce rounded-full bg-gray-500 dark:bg-gray-400" style={{ animationDelay: "0ms" }} />
              <div className="h-2 w-2 animate-bounce rounded-full bg-gray-500 dark:bg-gray-400" style={{ animationDelay: "150ms" }} />
              <div className="h-2 w-2 animate-bounce rounded-full bg-gray-500 dark:bg-gray-400" style={{ animationDelay: "300ms" }} />
            </div>
